...
Writestting code for academic purposes is sitestmilar to all acadtestemic writing in that students are required to follow similar guidelines.
...
2. Log into [Blackboard](https://learn.humber.ca/) and complete the Academic Integrity assessment. You will need to receive a 80% or higher grade on the assessment to receivve a SAT for this task (18/20). You may attempt the assessment as many times as needed. 
